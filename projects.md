...
- National and state administrative datasets (HCUP-NIS, HCUP-SID, Medicare)
- Statistical modeling, internal validation, and sensitivity analyses
- Machine learning approaches for variable selection and classification
...
Innovations include:
- National administrative dataset (HCUP-NIS, 2016–2022)  
- A data-driven complication classification system  
- Planned analyses of differential outcome effects stratified by extent of lung resection  
...
- Temporal changes in surgical ICU utilization  
- Increasing patient acuity and evolving admission sources  
- The changing landscape of postoperative critical care  
